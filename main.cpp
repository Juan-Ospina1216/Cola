...
public:
	...
	virtual void OnRender(void) //Transformaciones de lo que se muestra
	{
      ...
      if (shader) shader->begin();
        ...
        glTranslatef(0.0, 0.0, -8);   //Muestra los objetos en la pantalla mas lejos
      
        //glutSolidTeapot(0.5);   // Muestra la tetera

        Monja->DibujarPersonaje(6, 30, 0, 3, 0);  //Muestra la monja en pantalla
	...
	virtual void OnResize(int w, int h) //Es la inicializacion(Cambio tamaño de ventana)
   {
      if(h == 0) h = 1;
